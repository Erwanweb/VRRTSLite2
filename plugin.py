        ...
        if (Unit == 2):
            ...
            if (Devices[2].sValue == "10"):
                ...
                for idx in self.Blinds:
                    DomoticzAPI("type=command&param=switchlight&idx={}&switchcmd=Set%20Level&level=0".format(idx))
                    Domoticz.Debug("manual command - Close")

            elif (Devices[2].sValue == "20"):
                Devices[2].Update(nValue = 1,sValue = "20")
                for idx in self.Blinds:
                    DomoticzAPI("type=command&param=switchlight&idx={}&switchcmd=Set%20Level&level=20".format(idx))
